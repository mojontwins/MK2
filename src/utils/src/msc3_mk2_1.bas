...
if command (1) = "" or  maxidx = 0 then
	print "MojonTwins Scripts Compiler v3.96 20191124"
	print "MT Engine MK2 v1.00+"
	Print
...
Print #f3, "// Generated by Mojon Script Compiler v3.96 20191124 de la MT Engine MK2 v1.0+"
...
Print #f3, "    debug_print_16bits (0, 0, asm_int);"
Print #f3, "#endif"
Print #f3, ""
Print #f3, "#ifdef MODE_128K"
Print #f3, "    #asm"
