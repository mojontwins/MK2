...
#define TIMER_X 				30		//
#define TIMER_Y 				13		// Timer counter coordinates
#define FLAG_X					99		//
...
#define PLAYER_JMP_VY_MAX		75	 	// Max jump velocity
...
#define PLAYER_V_BOUNCE			64		// Bouncing speed
...
unsigned char behs [] = {
	0, 8, 8, 8, 8, 8, 8, 4, 4, 8, 8, 8, 8, 1, 0, 0,
