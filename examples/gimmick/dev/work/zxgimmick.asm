...
;
;	Module compile time: Wed Jan 01 16:49:23 2020
...
._ISR
	...
	ld b, 0
	call SetRAMBank
	ld	hl,(_tv_frame_counter)
	ld	h,0
	inc	hl
	ld	a,l
	ld	(_tv_frame_counter),a
	cp	#(50 % 256)
	jp	nz,i_20
	ld	a,#(0 % 256 % 256)
	ld	(__x),a
...
._ctx	defs	1
._cty	defs	1
._game_frame_counter	defs	1
._gps	defs	1
._gpt	defs	1
._rda	defs	1
._rdb	defs	1
._tv_frame_counter	defs	1
._p_x	defs	2
._AD_FREE	defs	975
._p_y	defs	2
._gpx	defs	1
...
; --- Start of Scope Defns ---
	...
	XDEF	_ctx
	XDEF	_cty
	XDEF	_game_frame_counter
	XDEF	_gps
	XDEF	_gpt
	XDEF	_rda
	XDEF	_rdb
	XDEF	_tv_frame_counter
	LIB	sp_SwapEndian
	LIB	sp_CharLeft
	XDEF	_p_x
	XDEF	_AD_FREE
