...
..\..\..\src\utils\map2bin.exe ..\map\mapa.map 10 2 99 ..\bin\map.bin ..\bin\bolts.bin force
move ..\bin\map.bin.spt ..\script

echo ### MAKING ENEMS ###
..\..\..\src\utils\ene2bin.exe 10 2 1 ..\enems\enems.ene ..\bin\enems.bin ..\bin\hotspots.bin

echo ### MAKING TILESET ###
..\..\..\src\utils\ts2bin.exe ..\gfx\font.png ..\gfx\work.png ..\bin\ts.bin forcezero

echo ### MAKING SPRITESET ###
..\..\..\src\utils\sprcnv.exe ..\gfx\sprites.png assets\sprites.h 18
...
echo ### MAKING SCRIPT ###
cd ..\script
..\..\..\src\utils\msc3_mk2_1.exe script.spt 20
