...
..\..\..\src\utils\map2bin.exe ..\map\mapa.map 3 3 99 ..\bin\map.bin ..\bin\bolts.bin force > nul
move ..\bin\map.bin.spt ..\script > nul

echo ### MAKING ENEMS ###
..\..\..\src\utils\ene2bin.exe 3 3 1 ..\enems\enems.ene ..\bin\enems.bin ..\bin\hotspots.bin > nul


echo ### MAKING TILESET ###
rem use this for 48K games:
..\..\..\src\utils\ts2bin.exe ..\gfx\font.png ..\gfx\work.png ..\bin\ts.bin > nul

rem use this for 128K games:
rem ..\..\..\src\utils\ts2bin.exe ..\gfx\font.png notiles ..\bin\font.bin forcezero > nul

echo ### MAKING SPRITESET ###
..\..\..\src\utils\sprcnv.exe ..\gfx\sprites.png assets\sprites.h 18 > nul
...
cd ..\texts
..\..\..\src\utils\textstuffer.exe texts.txt texts.bin 24
copy texts.bin ..\bin
...
echo ### MAKING SCRIPT ###
cd ..\script
..\..\..\src\utils\msc3_mk2_1.exe script.spt 9 > nul
...
echo ### MAKING TAPS ###
..\..\..\src\utils\bas2tap -a10 -sFINAL loader\loader.bas work\loader.tap  > nul
...
rem ..\..\..\src\utils\bas2tap -a10 -sFINAL loader\loader128.bas work\loader.tap  > nul
rem ..\..\..\src\utils\bin2tap -o work\loading.tap -a 16384 work\loading.bin  > nul
rem ..\..\..\src\utils\bin2tap -o work\reubica.tap -a 25000 loader\reubica.bin  > nul
rem ..\..\..\src\utils\bin2tap -o work\RAM1.tap -a 32768 work\ram1.bin  > nul
rem ..\..\..\src\utils\bin2tap -o work\RAM3.tap -a 32768 work\ram3.bin  > nul
rem ..\..\..\src\utils\bin2tap -o work\RAM4.tap -a 32768 work\ram4.bin  > nul
rem ..\..\..\src\utils\bin2tap -o work\RAM6.tap -a 32768 work\ram6.bin  > nul
rem ..\..\..\src\utils\bin2tap -o work\RAM7.tap -a 32768 work\ram7.bin  > nul
