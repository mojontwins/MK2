// Config.h
// Churrera v.5
// Copyleft 2010, 2011, 2013, 2014 The Mojon Twins
...
#define WIN_CONDITION			0		// 0 = objects collected, 1 = screen 'N', 2 = scripting
...
// Type 8 enemies are just type 1-4 enemies (linear, for the moment)
// which shoot cocos. v1. they just shoot 1 coco per enemy.
#define ENABLE_SHOOTERS					// If defined, type 8 enemies are active
#define TYPE_8_LINEAR_BEHAVIOUR			// They move like type 1-4 (more patterns to come)
#define TYPE_8_SHOOT_FREQ		63		// Shoot frequency (2^n-1)
#define TYPE_8_FIXED_SPRITE		0		// Type 8 enemies are always # - 1
#define TYPE_8_SAFE_DISTANCE	64		// if closer won't shoot
#define TYPE_8_FIRE_ONE					// If defined, just fire one coco per enemy
#define COCO_SPEED_8			6		// pixels per frame
...
#define PLAYER_CAN_PUNCH				// Player can punch.
...
//#define CLEAR_FLAGS				// If defined, clear flags each levels.
